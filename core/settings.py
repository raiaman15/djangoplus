...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'project-template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if DEBUG:
    ...
    MIDDLEWARE += ['livesync.core.middleware.DjangoLiveSyncMiddleware', ]
